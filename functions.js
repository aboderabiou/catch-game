...
function show_bulls_eye(egg) {
    bullsesye_num = egg.attr('data-bullseye');
    $('#bullesye' + bullsesye_num).show();
    hide_bulls_eye(bullsesye_num);
}

function hide_bulls_eye(bullsesye_num) {
    setTimeout(function () {
        $('#bullesye' + bullsesye_num).hide();
    }, 800);
}
